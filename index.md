...
<section class="hero">
  <div>
    ...
    <p>
      The lab combines behavioral experiments, formal computational models, and theory to connect
      perception, learning, and planning in dynamic environments.
    </p>
...
<section class="section-grid" aria-label="Research themes">
  <article>
    <h2>Perception</h2>
    <p>How observers infer hidden structure from noisy, partial, and conflicting sensory evidence.</p>
  </article>
  <article>
    <h2>Learning</h2>
    <p>How internal world models and structural priors are updated across experience.</p>
  </article>
  <article>
    <h2>Planning</h2>
    <p>How actions are selected when they must both achieve goals and reduce uncertainty.</p>
  </article>
</section>
